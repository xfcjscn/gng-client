...
require([ 'jquery', 'angular/angular', 'angular-route/angular-route', 'angular-resource/angular-resource', 'angular-animate/angular-animate',
        ...
        'angular-xeditable/dist/js/xeditable', 'ngAnimate-animate.css/animate', 'infra-client/app/scripts/models/angular-requirejs',
        'blockui/jquery.blockUI', 'swiper/dist/idangerous.swiper', 'infra-client/app/scripts/models/validator', 'css!normalize-css/normalize',
        'css!font-awesome/css/font-awesome', 'css!animate.css/animate', 'css!infra-client/app/styles/infra', 'swipe/swipe',
        'bootstrap/dist/js/bootstrap', 'underscore/underscore', 'underscore.string', 'modernizr/modernizr', 'simplecart-js/simpleCart',
        'css!infra-client/app/styles/infra', 'css!gng-client/app/styles/gplatform' ], function($) {
