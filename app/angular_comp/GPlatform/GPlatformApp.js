'use strict';
require(['jquery', 'infra-client/app/scripts/models/angular', 'infra-client/app/scripts/models/infra', 'css!infra-client/app/styles/infra', 'css!gng-client/app/styles/gplatform'], function ($, angular) {
